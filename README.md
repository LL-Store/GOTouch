# [GOTouch](https://github.com/LL-Store/GOTouch)
一款包含浏览器功能的桌面应用

> 支持`Windows`和`MacOS`电脑的使用（如果希望支持更多端，可以[ 留言 ](https://github.com/LL-Store/GOTouch/issues)告诉我们）！
...
最后，欢迎给我们[ 留言 ](https://github.com/LL-Store/GOTouch/issues)提建议，我们将逐步优化和丰富功能。
